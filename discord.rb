...
require 'discordrb'
require 'date'
require './hangtheman_game.rb'
quotes = []
admin_channel = 456810455910973470
...
bot.message(contains: '') do |event|
    if event.channel.id == 456796177573347329 || event.channel.id == admin_channel || event.channel.id == 456799494390939661 || event.channel.id == 456789157063163906
    ...
    if event.channel.id == admin_channel
        if event.message.content == '!hangtheman'
            hang_the_man('start')
        end
    end
    ## Quote command
